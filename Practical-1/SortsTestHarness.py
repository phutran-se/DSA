...
'''
SortsTestHarness.py - Sorting Test Cases
...
if len(sys.argv) < 3:
    ...
    for aa in range(2, len(sys.argv)):
        ...
        n = int(sys.argv[1])            # Number of intergers to sort
        sortType = sys.argv[aa][0]      # Sort type: b, i , s
        arrayType = sys.argv[aa][1]     # Array type: increase, descease, random and nearly sorted

        runningTotal = 0                # Time spending
